...
<div class="row" style="color: #000000 !important;">
    ...
    <div class="@if(!empty($receipt_details->show_qr_code) && !empty($receipt_details->qr_code_details))col-xs-8 @else col-xs-12 @endif">
        {!! $receipt_details->footer_text !!}
    </div>
    @endif
    
    @if(!empty($receipt_details->show_barcode) || !empty($receipt_details->show_qr_code))
