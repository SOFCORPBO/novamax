    ...
    <div class="col-md-12">
        <table class="table table-condensed">
            ...
            <tr>
              ...
              <td id="surcharge_pos_column" style="display: none;">
                    <span class="tw-text-base md:tw-text-lg tw-font-semibold">
                        <b class="tw-text-base md:tw-text-lg tw-font-bold" style="color:red;">Recargo(<span id="surcharge_pos_percent">0</span>%):</b> 
                        <span id="surcharge_pos_text" style="color:red;">0.00</span>
                    </span>
                </td>
                ```
