...
// =========================================================================
            // INICIO MODIFICACIÓN: CAPTURAR RECARGOS POR MÉTODO DE PAGO
            // =========================================================================
            $business_details['card_surcharge'] = !empty($request->input('card_surcharge')) ? $this->businessUtil->num_uf($request->input('card_surcharge')) : 0;
            $business_details['custom_pay_1_surcharge'] = !empty($request->input('custom_pay_1_surcharge')) ? $this->businessUtil->num_uf($request->input('custom_pay_1_surcharge')) : 0;
            $business_details['custom_pay_2_surcharge'] = !empty($request->input('custom_pay_2_surcharge')) ? $this->businessUtil->num_uf($request->input('custom_pay_2_surcharge')) : 0;
            $business_details['custom_pay_3_surcharge'] = !empty($request->input('custom_pay_3_surcharge')) ? $this->businessUtil->num_uf($request->input('custom_pay_3_surcharge')) : 0;
            // =========================================================================
